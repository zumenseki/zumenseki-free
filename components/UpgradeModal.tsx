...
export default function UpgradeModal({ isOpen, onClose, onUpgrade, reason }: UpgradeModalProps) {
  ...
  const handleExternalLink = () => {
    // 外部製品版サイトにリダイレクト（バックアップ）
    window.open('https://3006-i0dyukr6dptxhz58wne64-a7ad23cc.manusvm.computer', '_blank')
  }
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        ...
        <DialogFooter className="gap-2">
          ...
          <Button onClick={handleExternalLink} variant="outline" className="text-blue-600 border-blue-200 hover:bg-blue-50">
